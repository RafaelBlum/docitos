    ...
    <div class="main">
      ...
      <div class="section section-signup" style="background-image: url('assets/img/bg11.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
        <div class="container">
          ...
          <div class="col text-center">
            <a href="login-page.php" class="btn btn-outline-default btn-round btn-white btn-lg" target="_blank">View Login Page</a>
          </div>
        </div>
      </div>
      <div class="section section-examples" data-background-color="black">
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col">
              <a href="landing-page.php" target="_blank">
                <img src="assets/img/landing.jpg" alt="Image" class="img-raised">
              </a>
              <a href="landing-page.php" class="btn btn-outline-default btn-primary btn-round">View Landing Page</a>
            </div>
            <div class="col">
              <a href="profile-page.php" target="_blank">
                <img src="assets/img/profile.jpg" alt="Image" class="img-raised">
              </a>
              <a href="profile-page.php" class="btn btn-outline-default btn-primary btn-round">View Profile Page</a>
            </div>
          </div>
        </div>
      </div>
